        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-navy/70">(555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-navy/70">info@diamondbeauty.com</p>
                  </div>
                </div>
              </div>
              ...
              {/* Social Links */}
              <div>
                <h3 className="text-lg font-medium text-navy mb-4">Follow Us</h3>
                <div className="flex space-x-4">
                  <a href="#" className="text-navy/40 hover:text-teal">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full rounded-full bg-teal px-8 py-4 text-lg font-semibold text-cream shadow-sm hover:bg-mint hover:text-navy transition-colors"
                  >
                    Send Message
                  </button>
                </div>
          ...
          <div className="mt-16">
            <div className="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15134.859152938426!2d73.8122318!3d18.4796145!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bfb9e95f284d%3A0xa0e67976bf9be023!2sSinhagad%20Rd%2C%20Pune%2C%20Maharashtra%20411051!5e0!3m2!1sen!2sin!4v1716895762178!5m2!1sen!2sin"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
